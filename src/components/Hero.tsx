...
function HeroVisual({
  ...
  if (animate) {
    return <HeroScrollSequence variant={variant} className={className} />;
  }
...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative h-auto lg:min-h-[100svh]"
    >
      <div className="bg-gradient-hero-section relative isolate flex w-full flex-col overflow-hidden lg:min-h-[100svh] lg:h-dvh">
        {/* Copy — first on mobile, overlaid on desktop */}
